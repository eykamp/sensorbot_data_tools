...
pacman::p_load(pacman, RSQLite, DBI, R.utils, tidyverse)
...
Type `load("C:/dev/sensorbot/sensorbot.RData")` to load the `df` object with the sensorbot data.

This script loaded the most frequently used data from the database, but there is much more data to explore, including information on different device types and locations in the `sensorbot.db` file.
